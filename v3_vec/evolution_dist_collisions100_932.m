function evolution_dist_collisions100_932()
clc
clear
%rng_id = 5;
...
experiment = sprintf('evolution_dist_collisions100_932/%s', run_id);
draw = false;
...
for gen = 1:settings.gen_count
    ...
    [Fit, dists, collis, angles] = fitness_dist_collisions100(Pop, settings.map, settings.netLayout, ...
