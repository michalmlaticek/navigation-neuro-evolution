function data = a_fitness_path( ...
    ...
    for step = 1:step_count
       ...
       goal_rotation(close_proximity_idx) = goal_rotation(close_proximity_idx) + angle_errors(close_proximity_idx);
       exact_proximity_idx = target_distances == 0;
       goal_rotation(exact_proximity_idx) = goal_rotation(exact_proximity_idx) + d_angles(exact_proximity_idx);
    ...
    %%%% Fitness %%%%%%%
    data.fits = 0.1*data.dist_sum + 10*data.collisions + goal_rotation;
end
