function final_data = a_fitness(...
   ...
   % final_data.rotations = zeros(1, pop_size);
    final_data.meandists = zeros(1, pop_size);
    ...
    for path = 1:size(start_positions, 2)
        ...
        final_data.meandists = final_data.meandists + data.meandists;
    end
    ...
    %final_data.meandists = final_data.meandists / size(start_positions, 2);
end
