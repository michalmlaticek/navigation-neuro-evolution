There was en error in the fitness function, were it incorectly checked for collisions. It always just considered the first robot possition and that was assigned to all robots.
