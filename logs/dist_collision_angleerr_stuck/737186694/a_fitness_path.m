function data = a_fitness_path( ...
    ...
    for step = 1:step_count
       net_inputs = create_inputs(sensor_lines, robot.sensorLen, ...
           norm_angle_errors, norm_target_distances, move_mem, settings, map);
...
function ins = create_inputs(sensor_lines, sensor_len, angle_errors, target_distances, move_mem, settings, map)
    ...
    in_target_zone_idx = target_distances < settings.protected_distance;
    in_target_zone_idx(1, 1) = true;
