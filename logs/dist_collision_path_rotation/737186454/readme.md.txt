This is a restart of the prior run, where it now stores the Population, however a 'wrong' extraction mechanism is used for speed.

Managed to run: 128 generations
