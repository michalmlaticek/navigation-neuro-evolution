This is now almost correct set-up. Still the output extraction was used that can not fully stop.
However, the it seems that the radius of the robot is too big for the map used, so it was stopped after 1090 generation and restarted with radius 5 (vs original 10)

Num of generations run: 1090

fitness: 10*target_distances + 100*collisions + 0.001*path_lens + 0.001*rotations;
