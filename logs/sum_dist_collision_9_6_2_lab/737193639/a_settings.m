function settings = a_settings()
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%
    settings = {};
    settings.netLayout = [9 6 2];
    settings.genom_len = calculateWBCount(settings.netLayout);
    init_positions = [25 20; 75 230; 225 235];
    target_positions = [200 145; 70 20; 50 120];
