Bodies error + you can see on the charts, that this one also had the issue where only the first point from the body was counted for. So the collision count chart is not valid)

stopped in progress. Might be worh while to continue evolution

Fitness: distances + collisions*10 + combined_angle_errs*0.01;


Generations run: 1402
